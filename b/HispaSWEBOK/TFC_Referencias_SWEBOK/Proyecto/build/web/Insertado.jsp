...
<html>
    ...
    <div id="super">
		...
		<div id="pagina">
			...
			<div id="cuerpo">
    			<h3><%if (idioma.equals("espanhol")){out.println("Inserción de Nueva Referencia");}else{out.println("New Reference Inserted");}%></h3>
				<div id="listado">
                                        <p class="parrafo">
                                        <b><%if (idioma.equals("espanhol")){out.println("El dato ha sido insertado");}else{out.println("Reference inserted");}%></b></p>
                                        <br/>
                                        <p align="center"><a href="/Proyecto/Buscador.jsp"><%if (idioma.equals("espanhol")){out.println("Volver");}else{out.println("Return");}%></a></p>
                                        <br/><br/>
				</div>
    		</div>
			<div id="pie">
