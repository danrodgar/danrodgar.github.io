...
<html>
	...
	<div id="super">
		...
		<div id="pagina">
			...
			<div id="cuerpo2">
    			<br/><h3><%if (idioma.equals("espanhol")){out.println("Listado de Referencias Bibliogr&aacute;ficas");}else{out.println("Bibliographic References List");}%></h3>
				<!--<div id="listado">-->
					...
					<thead>
                                            <tr>
                                                ...
                                                <th abbr="ver"><%if (idioma.equals("espanhol")){out.println("VER");}else{out.println("DETAILS");}%></th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                       <%
                                       ...
                                       while ((cont<30)&&(comienzo<vector.getNumeroEntradas()))
					{
						ent.vaciaEntrada();
                                                ...
                                                <tr>
                                                        ...
                                                        <td class="ver">
                                                            <a href="bibtexServlet?accion=endetalle&key=<%=ent.getKey()%>&pagina=<%=pagina%>&idioma=<%=idioma%>&endnote=bibtex"><%if (idioma.equals("espanhol")){out.println("En detalle");}else{out.println("Details");}%></a>
                                                        </td>
                                                 </tr>
					<%
                                            cont++;
                                        ...
                                        <div id="paginacion">
                                            ...
                                            <%
                                             ...
                                             while(i<numeroPaginas+1)
                                             {
                                                 ...
                                                 {
                                                    %><a href="bibtexServlet?accion=listado&pagina=<%out.println(i);%>&idioma=<%=idioma%>"><%out.println(i);%></a><%
                                                 }
                                                 i++;                                            
                                             }
                                             %>
