...
if (idioma.equals("espanhol")){out.println("Aplicaci&oacute;n de Manejo y Consulta de Referencias Bibliogr&aacute;ficas de la Traducci&oacute;n del SWEBOK");}else{out.println("Operate and Search Aplication of Bibliographic References of SWEBOK");}
      ...
      out.write("    \t\t\t<br/><h3>");
if (idioma.equals("espanhol")){out.println("Seleccione la Referencia a Modificar");}else{out.println("Select the Reference");}
      out.write("</h3>\r\n");
...
if (idioma.equals("espanhol")){out.println("TIPO");}else{out.println("TYPE");}
      ...
      out.write("                                                <th abbr=\"ver\">MODIFICAR</th>\r\n");
      out.write("                                            </tr>\r\n");
      out.write("                                        </thead>\r\n");
      out.write("                                        <tbody>\r\n");
      out.write("                                       ");
...
if (idioma.equals("espanhol")){out.println("Modificar");}else{out.println("Modify");}
      ...
      out.write("<a href=\"bibtexServlet?accion=modificar&pagina=");
out.println(i);
      out.write('"');
      out.write('>');
out.println(i);
