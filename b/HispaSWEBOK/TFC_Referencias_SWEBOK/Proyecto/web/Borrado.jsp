...
<html>
    ...
    <div id="super">
		...
		<div id="pagina">
			...
			<div id="cuerpo">
    			<h3><%if (idioma.equals("espanhol")){out.println("Eliminación de una Referencia");}else{out.println("Delete Reference Done");}%></h3>
				<div id="listado">
                                        <p class="parrafo">
                                        <b><%if (idioma.equals("espanhol")){out.println("El Dato ha sido Eliminado");}else{out.println("Reference Deleted");}%></b></p>
                                        <br/>
