			...
			<div id="cuerpo">
			   <div class="buscador" align="center">
				<form method="post" name="miForm" action="bibtexServlet">
					...
					<input type="text" name="busqueda" maxlength="255" size="50"/>
					...
					<br/>
					<p align="center"><a href="BusquedaAvanzada.jsp?error=&idioma=<%=idioma%>">
                                            <%if (idioma.equals("espanhol")){out.println("Busqueda Avanzada");}else{out.println("Advanced Search");}%>
					</a></p>
					<br/>
					<input  type="submit" class=\"BotonSubmit\" name="boton"  style="position:relative;top:-2px;" title="Buscar en las referencias" <%if (idioma.equals("espanhol")){out.println("value=\"Buscar\"");}else{out.println("value=\"Search\"");}%>/>
					<br/><br/>
				</form>
			   </div>
