...
<html>
	...
	<div id="super">
		...
		<div id="pagina">
			...
			<div id="cuerpo2">
    			<br/><h3><%if (idioma.equals("espanhol")){out.println("Seleccione la Referencia a Eliminar");}else{out.println("Select the Reference to Delete");}%></h3>
				<!--<div id="listado">-->
					...
					<thead>
                                            <tr>
                                                ...
                                                <th abbr="ver"><%if (idioma.equals("espanhol")){out.println("BORRAR");}else{out.println("DELETE");}%></th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                       <%
                                       ...
                                       while ((cont<30)&&(comienzo<vector.getNumeroEntradas()))
					{
						ent.vaciaEntrada();
                                                ...
                                                <tr>
                                                        ...
                                                        <td class="ver">
                                                            <a href="bibtexServlet?accion=borrado&key=<%=ent.getKey()%>&pagina=<%=pagina%>&idioma=<%=idioma%>"><%if (idioma.equals("espanhol")){out.println("Eliminar");}else{out.println("Delete");}%></a>
                                                        </td>
                                                 </tr>
					<%
                                            cont++;
                                        ...
                                        <div id="paginacion">
                                            ...
                                            <%
                                             ...
                                             while(i<numeroPaginas+1)
                                             {
                                                 ...
                                                 {
                                                    %><a href="bibtexServlet?accion=borrar&pagina=<%out.println(i);%>"><%out.println(i);%></a><%
                                                 }
                                                 i++;                                            
                                             }
                                             %>
